...
class RNNAtt17(nn.Module):
    ...
    def forward(self, input):
        ...
        # right to left
        r2l_hids = hids.view(batch_size, 256,
            300,
            2
        )[:, :, :, 1]
